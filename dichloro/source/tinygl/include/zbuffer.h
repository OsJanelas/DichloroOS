...
#else
#include "includer.h"
static void gl_free(void* p) { FreeMemory(p); }
static void* gl_malloc(GLint size) { return allocatememory(size); }
static void* gl_zalloc(GLint size) { return callocatememory(1, size); }
#endif
